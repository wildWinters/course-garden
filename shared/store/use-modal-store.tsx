...
export const useModalStore = create<IuseModalStore>((set, get) => ({ 
  ...
  openCustomModalOfEmailSentContent: () => set({ isCustomModalOfEmailSentContentOpen: true }),
  closeCustomModalOfEmailSentContent: () => set({ isCustomModalOfEmailSentContentOpen: false }),
  openCustomModalOfForgotPassword: () => set({ isCustomModalOfForgotPasswordOpen: true }),
  closeCustomModalOfForgotPassword: () => set({ isCustomModalOfForgotPasswordOpen: false }),
  openCustomModalOfSignIn: () => set({ isCustomModalOfSignInOpen: true }),
  closeCustomModalOfSignIn: () => set({ isCustomModalOfSignInOpen: false }),
  openCustomModalOfCreateNewPassword: () => set({ isCustomModalOfCreateNewPasswordOpen: true }),
  closeCustomModalOfCreateNewPassword: () => set({ isCustomModalOfCreateNewPasswordOpen: false }),
}));
